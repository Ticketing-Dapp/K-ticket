...
contract Sell {
    ...
    event BuyTicket(uint256 _concert, uint256 _number);
    event TransferTicket(uint256 _concert, uint256 _number);
    event SetPrice(uint256 _concert, uint256 _number, uint256 _price);
     ...
     */
    function getHash(uint256 _concert, uint256 _number)
        public
        pure
        returns (bytes32)
    {
    ...
    function registerConcert(
        ...
        emit RegisterConcert(_concert, _number, _vipPrice, _rPrice, _aPrice);
    }
    ...
    function buyTicket(uint256 _concert, uint256 _number) public {
        ...
        emit BuyTicket(_concert, _number);
    }
    ...
    function setPrice(
        ...
        emit SetPrice(_concert, _number, _price);
    }
     ...
     */
    function checkMyTicket(uint256 _concert, uint256 _number)
        public
        view
        returns (bool)
    {
